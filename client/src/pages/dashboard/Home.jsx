  ...
  return (
    <div className="animate-fadeIn w-full" style={{ padding: '16px', paddingTop: '20px' }}>
      ...
      <div className="relative overflow-hidden" style={{
        ...
        <div className="absolute" style={{ right: '-20px', top: '-20px', width: '140px', height: '140px', borderRadius: '50%', background: 'radial-gradient(circle, rgba(0,255,204,0.35) 0%, rgba(120,60,200,0.15) 50%, transparent 75%)', filter: 'blur(10px)' }} />
