      ...
      <KeyboardAwareWrapper contentContainerStyle={{ padding: 20, paddingBottom: 60 }}>
        ...
        <View style={{ alignItems: 'center', marginBottom: 28 }}>
          <TouchableOpacity onPress={pickPhoto} activeOpacity={0.85}>
            <View style={{ width: 90, height: 90, borderRadius: 45, overflow: 'hidden', borderWidth: 3, borderColor: ACCENT, backgroundColor: 'rgba(0,255,204,0.12)', justifyContent: 'center', alignItems: 'center' }}>
        ...
        {bizName ? (
          <View style={{ backgroundColor: CARD, borderRadius: 20, padding: 20, borderWidth: 1, borderColor: BORDER, marginBottom: 16 }}>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 14 }}>
              <View style={{ width: 48, height: 48, borderRadius: 14, overflow: 'hidden', backgroundColor: 'rgba(0,255,204,0.12)', justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderColor: BORDER }}>
          ...
          <View style={{ gap: 4 }}>
            {Object.keys(LANG_IMAGES).map((l) => (
              <TouchableOpacity
                ...
                activeOpacity={0.8}
                style={{ flexDirection: 'row', alignItems: 'center', gap: 14, padding: 12, borderRadius: 14, borderWidth: 1.5, borderColor: language === l ? ACCENT : 'rgba(255,255,255,0.06)', backgroundColor: language === l ? 'rgba(0,255,204,0.10)' : 'transparent' }}
              >
