        ...
        <View style={{ paddingHorizontal: 20 }}>
          ...
          {isMorocco ? (
            ...
            <View style={{ marginBottom: 28 }}>
              <View style={{ backgroundColor: 'rgba(0,180,216,0.06)', borderRadius: 16, padding: 18, borderWidth: 1, borderColor: 'rgba(0,180,216,0.15)', marginBottom: 14 }}>
                <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 8 }}>
              ...
              <TouchableOpacity onPress={openInternational} activeOpacity={0.85}
                ...
                <View style={{ width: 52, height: 52, borderRadius: 14, backgroundColor: 'rgba(0,180,216,0.1)', justifyContent: 'center', alignItems: 'center' }}>
              ...
              >
                {activeMethod && (<>
                  ...
                  <HapticButton onPress={handleSubmit} disabled={submitting} style={{ marginTop: 8 }}>
                    <LinearGradient colors={['#4facfe', '#0096FF']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }}
