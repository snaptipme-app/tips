      ...
      <KeyboardAwareWrapper contentContainerStyle={{ padding: 20, paddingBottom: 60 }}>
        ...
        <View style={{ alignItems: 'center', marginBottom: 32 }}>
          <TouchableOpacity onPress={pickLogo} activeOpacity={0.85}>
            <View style={{ width: 100, height: 100, borderRadius: 50, overflow: 'hidden', borderWidth: 3, borderColor: ACCENT, backgroundColor: 'rgba(255,255,255,0.12)', justifyContent: 'center', alignItems: 'center' }}>
              {logoSrc ? (
                <Image source={{ uri: logoSrc }} style={{ width: 100, height: 100 }} />
              ) : (
                <Ionicons name="business-outline" size={36} color="rgba(255,255,255,0.5)" />
              )}
            </View>
