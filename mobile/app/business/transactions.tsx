...
export default function Transactions() {
  ...
  const renderTx = ({ item }: { item: Transaction }) => {
    ...
    return (
      ...
      >
        {/* Avatar */}
        <View style={{ width: 42, height: 42, borderRadius: 21, overflow: 'hidden', backgroundColor: 'rgba(0,255,204,0.12)', justifyContent: 'center', alignItems: 'center', marginRight: 12, borderWidth: 1.5, borderColor: 'rgba(0,255,204,0.25)' }}>
          {photoSrc ? (
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={{ alignItems: 'center', paddingTop: 80 }}>
              <View style={{ width: 80, height: 80, borderRadius: 40, backgroundColor: 'rgba(0,255,204,0.06)', justifyContent: 'center', alignItems: 'center', marginBottom: 16, borderWidth: 1, borderColor: BORDER }}>
