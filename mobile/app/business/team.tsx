    ...
    return (
      ...
      >
        ...
        <View style={{
          ...
          borderWidth: 2, borderColor: 'rgba(0,255,204,0.3)',
          justifyContent: 'center', alignItems: 'center',
          backgroundColor: 'rgba(0,255,204,0.12)', marginRight: 14,
        }}>
          {photo ? (
          ...
          ListEmptyComponent={
            <View style={{ alignItems: 'center', paddingTop: 80 }}>
              <View style={{
                ...
                justifyContent: 'center', alignItems: 'center',
                marginBottom: 16, borderWidth: 1, borderColor: 'rgba(0,255,204,0.1)',
              }}>
