        ...
        {accountOptions.map((opt) => {
          ...
          return (
            <TouchableOpacity key={opt.key} onPress={() => onAccountType(opt.key)} activeOpacity={0.8} style={{
              flex: 1, padding: 14, borderRadius: 14, backgroundColor: sel ? 'rgba(0,180,216,0.12)' : INPUT_BG,
              borderWidth: 1.5, borderColor: sel ? ACCENT : BORDER, alignItems: 'center',
            }}>
              <View style={{ width: 40, height: 40, borderRadius: 12, backgroundColor: sel ? 'rgba(0,180,216,0.15)' : 'rgba(255,255,255,0.06)', justifyContent: 'center', alignItems: 'center', marginBottom: 6 }}>
      ...
      >
        {country ? (
          <>
            ...
            <View style={{ backgroundColor: 'rgba(0,180,216,0.2)', borderRadius: 8, paddingHorizontal: 8, paddingVertical: 3 }}>
          ...
          <View style={{ backgroundColor: SHEET_BG, borderTopLeftRadius: 24, borderTopRightRadius: 24, paddingBottom: 40 }}>
            ...
            {COUNTRY_OPTIONS.map((c) => (
              ...
              >
                ...
                <View style={{ backgroundColor: selectedCountry === c.id ? 'rgba(0,180,216,0.2)' : 'rgba(255,255,255,0.06)', borderRadius: 8, paddingHorizontal: 8, paddingVertical: 3 }}>
