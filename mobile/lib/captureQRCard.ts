...
export const downloadAndShareQRCard = async (
  ...
  try {
    ...
    const avatarSection = photoSrc
      ? `<img src="${photoSrc}" style="width:52px;height:52px;border-radius:50%;border:2.5px solid #00ffcc;object-fit:cover;display:block;margin:0 auto;" />`
      : `<div style="width:52px;height:52px;border-radius:50%;background:#00ffcc;border:2.5px solid #a78bfa;margin:0 auto;display:flex;align-items:center;justify-content:center;font-size:22px;font-weight:700;color:white;line-height:52px;text-align:center;">${initials}</div>`;
